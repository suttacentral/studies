...
As specified in the [overlay rationale](https://github.com/ing-bank/lion/blob/8a322836ce238bd09d6c73f1a947d130e01cb697/docs/docs/systems/overlays/rationale.md) there are only two official types of overlays: dialogs and tooltips. And their main differences are:
...
> An example implementation can be found in [lion-tooltip](https://github.com/ing-bank/lion/blob/8a322836ce238bd09d6c73f1a947d130e01cb697/docs/components/interaction/tooltip/overview.md), where an arrow is set by default.
